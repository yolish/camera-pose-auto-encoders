...
percent = 0.3
labels_file = "7Scenes/7scenes_all_scenes.csv_{}_subset.csv".format(percent)
...
out_file = open("7scenes_training_pairs_{}_subset.csv".format(percent), 'w')
...
for s in ['chess', 'fire', 'heads', 'office', 'pumpkin', 'redkitchen', 'stairs']:
    ...
    for j in range(n-1):
        ...
        for k in range(random.randint(0,n//100), n, n//int(percent*100)):
